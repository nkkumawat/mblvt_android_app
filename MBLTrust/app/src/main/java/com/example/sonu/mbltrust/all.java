...
public class all extends AppCompatActivity {
    ...
    public void CustomDialog(){
        ...
        View todaysthought =(View) dialog.findViewById(R.id.demo3);
        View gallery =(View) dialog.findViewById(R.id.demo4);
        View jsonActivity =(View) dialog.findViewById(R.id.demo5);
        ...
        todaysthought.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext() , todayThought.class);
        ...
        jsonActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext() , jsonActiviy.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
